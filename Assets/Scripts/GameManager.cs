...
public class GameManager : MonoBehaviour
{
    ...
    public bool HasPawnMoved(GameObject pawn) => movedPawns.Contains(pawn);
    ...
    public bool DoesPieceBelongToCurrentPlayer(GameObject piece) => currentPlayer.pieces.Contains(piece);
